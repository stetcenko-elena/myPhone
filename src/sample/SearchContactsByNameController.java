...
public class SearchContactsByNameController {
    ...
    public SearchContactsByNameController() {
    ...
    public void searchContactsToName() throws IOException {
        String value = name.getText();
        ContactManager contactManager = new ContactManager();
        ObservableList observableList = null;
        try {
            observableList = contactManager.searchContactsByFirstOrLastName(value);
    ...
    public void searchContactsToPartName() throws IOException {
        String value = name.getText();
        ContactManager contactManager = new ContactManager();
        ObservableList observableList = null;
        try {
            observableList = contactManager.searchContactsByAnyPartOfName(value);
        } catch (ContactNotFoundException e) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Information");
            alert.setHeaderText(e.getMessage());
